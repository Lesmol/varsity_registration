This repository is for the front end of the Varsity Registration web app we are creating. The project utilises Next.js as the front-end framework and Firebase to handle user authentication.
